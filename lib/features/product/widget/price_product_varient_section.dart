...
class PricingVariantSection extends StatefulWidget {
  ...
  @override
  State<PricingVariantSection> createState() => _PricingVariantSectionState();
}

class _PricingVariantSectionState extends State<PricingVariantSection> {
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Pricing & Product Variants - Section ${widget.index}',
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          widget.selectedImage == null ? 'Add Media' : 'Change Media',
                          style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                        ),
                        Text(
                          widget.selectedImage == null ? 'Add media for this product' : 'Tap to select a different image',
